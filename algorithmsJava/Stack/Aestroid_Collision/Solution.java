...
//             /* if +ve direction aestroid than simply add to stack
...
//             if(incoming <0){
//                /* cases of -ve where collison can occur */
                
//                /* if top of stack is +ve and less than incoming */
//                 while(!stack.empty() && stack.peek() > 0 
//                       && Math.abs(incoming) > stack.peek())                                                 {stack.pop();}
                
//                 /* either -ve was the first element to come or incoming removed all */
//                 if(stack.empty() || stack.peek() <0){
//                     stack.push(incoming);
//                 }
                
//                 /* incoming is same as stack top */
//                 if(!stack.isEmpty() && Math.abs(incoming) == stack.peek())
//                       stack.pop();
//             } 
//             i++;
//         }
